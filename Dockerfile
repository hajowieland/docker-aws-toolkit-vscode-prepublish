FROM ubuntu:latest
# Original by https://github.com/aws/aws-toolkit-vscode/blob/develop/Dockerfile
...
CMD npm install --unsafe-perm && && npm install -g --unsafe-perm vsce && npm run vscode:prepublish && xvfb-run npm test --silent
CMD npm run package
